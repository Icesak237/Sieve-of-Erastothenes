...
A personal project where I implement the
[Sieve of Eratosthenes](https://en.wikipedia.org/wiki/Sieve_of_Eratosthenes) in
as many old programming languages as I can before I get bored. I started this
because I thought it would be fun to see how the same algorithm looks and feels
across very different languages from different eras of computing.
